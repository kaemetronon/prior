export const HINTS = {
  importance: [
    '10 – критически важно, без этого всё встанет',
    '9 – очень важно, влияет на ключевые процессы',
    '8 – важно для достижения целей',
    '7 – желательно сделать для улучшения результата',
    '6 – полезно, но не критично',
    '5 – средняя важность, можно отложить',
    '4 – несущественно, малозначимо',
    '3 – почти не важно, мало что изменит',
    '2 – формальность, можно забыть',
    '1 – не имеет значения',
  ],
  urgency: [
